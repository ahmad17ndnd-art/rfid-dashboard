const I18N = {
  ar: {
    ...
    create_account_link: "ما عندك حساب؟ سجّل واحد جديد",
    register_title: "إنشاء حساب جديد",
    register_desc: "حساب جديد ببياناته الخاصة فيه — بطاقاتك وسجلك ما حدا غيرك بيشوفه.",
    ...
    device_key_title: "مفتاح الجهاز الخاص فيك",
    device_key_desc: "هاد المفتاح خاص فيك بس، وما حدا غيرك بيقدر يشوف أو يستخدم بياناتك. حطّه بكود ESP32 تبعك بمكان DEVICE_API_KEY عشان الجهاز يرتبط بحسابك.",
    copy: "نسخ",
    regenerate_key: "توليد مفتاح جديد (يوقف الجهاز القديم)",
    key_copied: "تم النسخ ✔",
  ...
  en: {
    ...
    create_account_link: "No account? Create a new one",
    register_title: "Create a new account",
    register_desc: "A new account with its own private data — your cards and logs are visible only to you.",
    ...
    device_key_title: "Your Device Key",
    device_key_desc: "This key is yours alone — no one else can see or use your data. Put it in your ESP32 code under DEVICE_API_KEY so the device links to your account.",
    copy: "Copy",
    regenerate_key: "Generate new key (disconnects old device)",
    key_copied: "Copied ✔",
