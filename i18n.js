const I18N = {
  ar: {
    ...
    register_title: "إنشاء حساب أدمن جديد",
    register_desc: "هاد الحساب رح يقدر يدخل على كل ميزات النظام (فتح الباب، البطاقات، السجلات).",
    confirm_password: "تأكيد كلمة المرور",
    register_btn: "إنشاء الحساب",
    err_password_mismatch: "كلمتا المرور مو متطابقتين",
    err_email_exists: "هاد الإيميل مسجل مسبقاً",
    err_password_short: "كلمة المرور لازم تكون 6 أحرف عالأقل",
  ...
  en: {
    ...
    register_title: "Create New Admin Account",
    register_desc: "This account will have access to all system features (door control, cards, logs).",
